...
export const openDialog: Partial<TypeOptions["resources"]["openDialog"]> = {
  ...
  collaborateTitle: "使用 ISS Cloud Studio 数据平台加速开发",
  ...
  newToFoxgloveStudio: "第一次使用 ISS Cloud Studio？",
  ...
  openUrl: "上传和共享数据",
  openUrlDescription: "使用 ISS Cloud Studio 数据平台与您的团队共享数据。",
  recentDataSources: "最近使用的数据源",
  secureStorageOfData: "安全地存储 PB 级的 ROS 或自定义数据",
  seeTutorials: "查看教程",
  shareLayouts: "分享布局",
  signIn: "登录",
  startCollaborating: "与您的 ISS Cloud Studio 组织开始合作",
  startCollaboratingDescription:
    "充分利用你的 ISS Cloud Studio 账户——无论你想深入研究你的数据还是与你的团队成员分享工具。",
