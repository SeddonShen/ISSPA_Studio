...
function DirectionalPad(props: DirectionalPadProps): JSX.Element {
  ...
  return (
    ...
    <ButtonGroup >
    <IconButton {...makeMouseHandlers(DirectionalPadAction.REVERSELEFT)} >
      <LeftIcon />
    </IconButton>
    <IconButton {...makeMouseHandlers(DirectionalPadAction.STOP)} >
      <StopIcon />
    </IconButton>
    <IconButton {...makeMouseHandlers(DirectionalPadAction.REVERSERIGHT)} >
      <RightIcon />
    </IconButton>
  </ButtonGroup>
    </>
